...
export default function ChatWidget() {
  ...
  async function handleCollectionInput(value: string) {
    ...
    const isLastStep = collectionStep === collectionSteps.length - 1;
    ...
    <div className="relative flex flex-col flex-1 overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-3.5 border-b border-gray-100 bg-white">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-400">
            {phase === "connected" ? t.headerSubConnected : t.headerSubAI}
          </p>
        </div>
        {phase === "connected" && (
      ...
      {phase === "connected" && (
        <div className="border-t border-gray-100 bg-white px-4 py-4 pb-[max(16px,env(safe-area-inset-bottom))]">
          <p className="text-center text-xs text-gray-400">{t.connectedFooter}</p>
        </div>
      )}
              ...
              <div className="space-y-3">
                {photoPreview ? (
                  ...
                  <>
                    ...
                    <button
                      onClick={() =>
                        handleCollectionInput("No photo provided")
                      }
